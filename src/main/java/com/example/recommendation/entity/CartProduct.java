...
public class CartProduct {
    ...
    public CartProduct(int productId, String productCategory, String productName, String productSecondCategory, String fileName, String description, Double price, int sellCount, int cartCount) {
